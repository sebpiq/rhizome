...
_.extend(ConnectionManager.prototype, coreValidation.ValidateConfigMixin, {
  ...
  start: function(done) {
    ...
    this._validateConfig(function(err) {
      ...
      self._runQueueHandle = setInterval(function() {
  ...
  stop: function(done) {
    ...
    clearInterval(this._runQueueHandle)
