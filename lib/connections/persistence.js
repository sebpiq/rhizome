...
var NEDBStore = exports.NEDBStore = function() {
...
_.extend(NEDBStore.prototype, {
  ...
  start: function(done) {
    this._connectionsCollection = new nedb({ filename: '/tmp/rhizome-connections.db' })
    this._connectionsCollection.loadDatabase(done)
  },

  stop: function(done) {
    new nedb({ filename: '/tmp/rhizome-connections.db' })
    done()
  },
