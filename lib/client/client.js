...
var socket, nsTree, wsStates
  , waitCloseAndRetry // Event handler for retrying when closing
wsStates = _.object([
    ...
    var retry = function() {
      ...
      createSocket(function(err) {
        if (err) {
          ...
          setTimeout(function() { retry('FFFFFffff ' + exports.config.retry) }, exports.config.retry)
        } else {
