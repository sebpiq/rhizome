...
_.extend(Client.prototype, EventEmitter.prototype, coreValidation.ValidateConfigMixin, {
  ...
  send: function(address, args) {
    ...
    // Some browsers (e.g. Safari on iOS7) convert the buffer to string 
    // before sending, even if binary seems to be supported. 
  ...
  _connect: function(done) {
    ...
    if (this._isBrowser) {
      ...
      query.os = navigator.oscpu || navigator.platform
      query.browser = navigator.userAgent
    }
