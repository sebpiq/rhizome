The *example* folder contains a full **rhizome** application. It is a very simple example of two ways communication between a Pd/SuperCollider patch and a webpage.
