...
var nx = function() {
	...
	**/
	...
	this.nxTransmit = function (data) {
		...
		} else if (this.transmissionProtocol == "rhizome") {

			if ((typeof data == "object") && (data !== null)) {
				for (var key in data) {

					var rzuser = 0
					var rzosc = "/"+rhizome.userId+this.oscName+"/"+key;
					rhizome.send(rzosc, [data[key]]);

				}
			} else if (typeof data == "number" || typeof data == "string") {
				
				var rzosc = "/"+rhizome.userId+this.oscName;
				rhizome.send(rzosc, [data]);
			}
